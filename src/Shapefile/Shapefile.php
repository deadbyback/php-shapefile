...
abstract class Shapefile
{
    ...
    const OPTION_DBF_FORCE_ALL_CAPS_DEFAULT = false;
    ...
    {
        $this->charset = $charset ?: mb_detect_encoding($input, ['ASCII', 'Windows-1251', 'ISO-8859-1'], true);
        if (!$this->charset) {
            $this->charset = Shapefile::DBF_DEFAULT_CHARSET;
        }
    ...
    private function sanitizeDBFFieldName($input)
    {
        ...
        $ret        = substr(preg_replace('/[^а-яА-ЯёЁa-zA-Z0-9]/', '_', $input), 0, 10);
